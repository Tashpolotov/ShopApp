...
import com.example.shopapp.databinding.FragmentTabPanelBinding
...
class TabPanelFragment : Fragment(),  View.OnClickListener, View.OnKeyListener  {
    ...
    override fun onCreateView(
        ...
        val categoryDao = AppDatabase.getInstance((context as FragmentActivity).application).categoryDao
